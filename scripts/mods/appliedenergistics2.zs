...
regrind(<actuallyadditions:block_misc:3>        , <actuallyadditions:item_dust:7>, true, <jaopca:dust.tinycoal>);
regrind(<appliedenergistics2:charged_quartz_ore>, <jaopca:dust.chargedcertusquartz>, true, <jaopca:dust.tinydiamond>);
regrind(<appliedenergistics2:quartz_ore>        , <appliedenergistics2:material:2>, true, <jaopca:dust.tinyquartz>);
regrind(<astralsorcery:blockcustomore:1>        , <astralsorcery:itemcraftingcomponent:2>, true, <contenttweaker:dust_tiny_silver>);
regrind(<astralsorcery:blockcustomsandore>      , <jaopca:dust.aquamarine>, true, <jaopca:dust.tinyaluminium>);
regrind(<biomesoplenty:gem_ore:1>               , <jaopca:dust.ruby>, true, <jaopca:dust.tinyaluminium>);
regrind(<biomesoplenty:gem_ore:2>               , <jaopca:dust.peridot>, true, <jaopca:dust.tinyemerald>);
regrind(<biomesoplenty:gem_ore:3>               , <jaopca:dust.topaz>, true, <jaopca:dust.tinyquartzblack>);
regrind(<biomesoplenty:gem_ore:4>               , <jaopca:dust.tanzanite>, true, <jaopca:dust.tinyquartz>);
regrind(<biomesoplenty:gem_ore:5>               , <jaopca:dust.malachite>, true, <ic2:dust:22>);
regrind(<biomesoplenty:gem_ore:6>               , <jaopca:dust.sapphire>, true, <jaopca:dust.tinyaluminium>);
regrind(<biomesoplenty:gem_ore>                 , <jaopca:dust.amethyst>, true, <jaopca:dust.tinycobalt>);
regrind(<draconicevolution:draconium_ore>       , <draconicevolution:draconium_dust>, true, <jaopca:dust.tinyardite>);
regrind(<endreborn:block_wolframium_ore>        , <qmd:dust>, true, <jaopca:dust.tinymagnesium>);
regrind(<forestry:resources>                    , <jaopca:dust.apatite>, true, <jaopca:dust.tinyaluminium>);
regrind(<immersiveengineering:ore:5>            , <immersiveengineering:metal:14>, true);
regrind(<libvulpes:ore0:8>                      , <libvulpes:productdust:7>, true, <jaopca:dust.tinytungsten>);
regrind(<libvulpes:ore0>                        , <libvulpes:productdust>, true, <ic2:dust:24>);
regrind(<mekanism:oreblock>                     , <mekanism:dust:2>, true, <jaopca:dust.tinynickel>);
regrind(<minecraft:coal_ore>                    , <thermalfoundation:material:768>, true, <jaopca:dust.tinyquartzblack>);
regrind(<minecraft:diamond_ore>                 , <ic2:dust:5>, true, <jaopca:dust.tinycertusquartz>);
regrind(<minecraft:emerald_ore>                 , <actuallyadditions:item_dust:3>, true, <jaopca:dust.tinyperidot>);
regrind(<minecraft:gold_ore>                    , <thermalfoundation:material:1>, true, <contenttweaker:dust_tiny_silver>);
regrind(<minecraft:iron_ore>                    , <thermalfoundation:material>, true, <jaopca:dust.tinynickel>);
regrind(<minecraft:lapis_ore>                   , <ic2:dust:9>, true, <jaopca:dust.tinyapatite>);
regrind(<minecraft:quartz_ore>                  , <appliedenergistics2:material:3>, true, <rustic:dust_tiny_iron>);
regrind(<minecraft:redstone_ore>                , <minecraft:redstone>, true, <jaopca:dust.tinycoal>);
regrind(<nuclearcraft:ore:3>                    , <nuclearcraft:dust:3>, true, <jaopca:dust.tinyuranium>);
regrind(<nuclearcraft:ore:5>                    , <nuclearcraft:dust:5>, true, <jaopca:dust.tinymagnesium>);
regrind(<nuclearcraft:ore:6>                    , <ic2:dust:11>, true, <jaopca:dust.tinyaluminium>);
regrind(<nuclearcraft:ore:7>                    , <nuclearcraft:dust:7>, true, <rustic:dust_tiny_iron>);
regrind(<rftools:dimensional_shard_ore>         , <jaopca:dust.dimensionalshard>, true, <jaopca:dust.tinyastralstarmetal>);
regrind(<tconstruct:ore:1>                      , <enderio:item_material:30>, true, <jaopca:dust.tinyosmium>);
...
regrind(<thermalfoundation:ore:5>               , <thermalfoundation:material:69>, true, <jaopca:dust.tinyplatinum>);
regrind(<thermalfoundation:ore:6>               , <thermalfoundation:material:70>, true, <jaopca:dust.tinynickel>);
regrind(<thermalfoundation:ore:7>               , <thermalfoundation:material:71>, true, <jaopca:dust.tinyplatinum>);
...
regrind(<trinity:trinitite>                     , <jaopca:dust.trinitite>, true, <jaopca:dust.tinytrinitite>);
