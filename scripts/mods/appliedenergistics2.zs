...
regrind(<actuallyadditions:block_misc:3>        , <actuallyadditions:item_dust:7>, true, <jaopca:tiny_dust.coal>);
regrind(<appliedenergistics2:charged_quartz_ore>, <jaopca:dust.chargedcertusquartz>, true, <jaopca:tiny_dust.diamond>);
regrind(<appliedenergistics2:quartz_ore>        , <appliedenergistics2:material:2>, true, <jaopca:tiny_dust.quartz>);
regrind(<astralsorcery:blockcustomore:1>        , <astralsorcery:itemcraftingcomponent:2>, true, <contenttweaker:dust_tiny_silver>);
regrind(<astralsorcery:blockcustomsandore>      , <jaopca:dust.aquamarine>, true, <jaopca:tiny_dust.aluminium>);
regrind(<biomesoplenty:gem_ore:1>               , <jaopca:dust.ruby>, true, <jaopca:tiny_dust.aluminium>);
regrind(<biomesoplenty:gem_ore:2>               , <jaopca:dust.peridot>, true, <jaopca:tiny_dust.emerald>);
regrind(<biomesoplenty:gem_ore:3>               , <jaopca:dust.topaz>, true, <jaopca:tiny_dust.quartzblack>);
regrind(<biomesoplenty:gem_ore:4>               , <jaopca:dust.tanzanite>, true, <jaopca:tiny_dust.quartz>);
regrind(<biomesoplenty:gem_ore:5>               , <jaopca:dust.malachite>, true, <ic2:dust:22>);
regrind(<biomesoplenty:gem_ore:6>               , <jaopca:dust.sapphire>, true, <jaopca:tiny_dust.aluminium>);
regrind(<biomesoplenty:gem_ore>                 , <jaopca:dust.amethyst>, true, <jaopca:tiny_dust.cobalt>);
regrind(<draconicevolution:draconium_ore>       , <draconicevolution:draconium_dust>, true, <jaopca:tiny_dust.ardite>);
regrind(<endreborn:block_wolframium_ore>        , <qmd:dust>, true, <jaopca:tiny_dust.magnesium>);
regrind(<forestry:resources>                    , <jaopca:dust.apatite>, true, <jaopca:tiny_dust.aluminium>);
regrind(<immersiveengineering:ore:5>            , <immersiveengineering:metal:14>, true);
regrind(<libvulpes:ore0:8>                      , <libvulpes:productdust:7>, true, <jaopca:tiny_dust.tungsten>);
regrind(<libvulpes:ore0>                        , <libvulpes:productdust>, true, <ic2:dust:24>);
regrind(<mekanism:oreblock>                     , <mekanism:dust:2>, true, <jaopca:tiny_dust.nickel>);
regrind(<minecraft:coal_ore>                    , <thermalfoundation:material:768>, true, <jaopca:tiny_dust.quartzblack>);
regrind(<minecraft:diamond_ore>                 , <ic2:dust:5>, true, <jaopca:tiny_dust.certusquartz>);
regrind(<minecraft:emerald_ore>                 , <actuallyadditions:item_dust:3>, true, <jaopca:tiny_dust.peridot>);
regrind(<minecraft:gold_ore>                    , <thermalfoundation:material:1>, true, <contenttweaker:dust_tiny_silver>);
regrind(<minecraft:iron_ore>                    , <thermalfoundation:material>, true, <jaopca:tiny_dust.nickel>);
regrind(<minecraft:lapis_ore>                   , <ic2:dust:9>, true, <jaopca:tiny_dust.apatite>);
regrind(<minecraft:quartz_ore>                  , <appliedenergistics2:material:3>, true, <rustic:dust_tiny_iron>);
regrind(<minecraft:redstone_ore>                , <minecraft:redstone>, true, <jaopca:tiny_dust.coal>);
regrind(<nuclearcraft:ore:3>                    , <nuclearcraft:dust:3>, true, <jaopca:tiny_dust.uranium>);
regrind(<nuclearcraft:ore:5>                    , <nuclearcraft:dust:5>, true, <jaopca:tiny_dust.magnesium>);
regrind(<nuclearcraft:ore:6>                    , <ic2:dust:11>, true, <jaopca:tiny_dust.aluminium>);
regrind(<nuclearcraft:ore:7>                    , <nuclearcraft:dust:7>, true, <rustic:dust_tiny_iron>);
regrind(<rftools:dimensional_shard_ore>         , <jaopca:dust.dimensionalshard>, true, <jaopca:tiny_dust.astralstarmetal>);
regrind(<tconstruct:ore:1>                      , <enderio:item_material:30>, true, <jaopca:tiny_dust.osmium>);
regrind(<tconstruct:ore>                        , <enderio:item_material:31>, true, <rustic:dust_tiny_iron>);
regrind(<thaumcraft:ore_amber>                  , <jaopca:dust.amber>, true, <rustic:dust_tiny_iron>);
...
regrind(<thermalfoundation:ore:5>               , <thermalfoundation:material:69>, true, <jaopca:tiny_dust.platinum>);
regrind(<thermalfoundation:ore:6>               , <thermalfoundation:material:70>, true, <jaopca:tiny_dust.nickel>);
regrind(<thermalfoundation:ore:7>               , <thermalfoundation:material:71>, true, <jaopca:tiny_dust.platinum>);
...
regrind(<trinity:trinitite>                     , <jaopca:dust.trinitite>, true, <jaopca:tiny_dust.trinitite>);
