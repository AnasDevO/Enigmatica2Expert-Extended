...
MINER: [[
    ...
    <jaopca:thaumcraft_cluster.tungsten>,
    <thaumcraft:cluster:4>,
    <jaopca:thaumcraft_cluster.draconium>,
    <jaopca:thaumcraft_cluster.titanium>,
    <jaopca:thaumcraft_cluster.ruby>,
  ], [
    <extrautils2:compresseddirt:2>,
    <jaopca:thaumcraft_cluster.iridium>,
    <jaopca:thaumcraft_cluster.astralstarmetal>,
    <thaumcraft:thaumium_pick>,
    <thaumcraft:thaumium_shovel>,
    <thaumcraft:thaumium_axe>,
  ], [
    <extrautils2:compressednetherrack:2>,
    <jaopca:thaumcraft_cluster.mithril>,
    <jaopca:thaumcraft_cluster.tanzanite>,
