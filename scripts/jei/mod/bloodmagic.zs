...
addMeteor(<jaopca:block.dilithium:0> , 1000000, [<ore:sandOxidisedFerric> * 147, <ore:oreEndDilithium> * 73, <ore:oreClathrateRedstone> * 29, <ore:oreClathrateEnder> * 29, <ore:oreClathrateGlowstone> * 29]);
