...
infinFurnace(utils.get('jaopca:ic2_purified_crushed.aluminium'), utils.get('thermalfoundation:material', 132));
infinFurnace(utils.get('jaopca:ic2_purified_crushed.ardite'), utils.get('tconstruct:ingots', 1));
infinFurnace(utils.get('jaopca:ic2_purified_crushed.astralstarmetal'), utils.get('astralsorcery:itemcraftingcomponent', 1));
infinFurnace(utils.get('jaopca:ic2_purified_crushed.boron'), utils.get('nuclearcraft:ingot', 5));
infinFurnace(utils.get('jaopca:ic2_purified_crushed.cobalt'), utils.get('tconstruct:ingots'));
infinFurnace(utils.get('jaopca:ic2_purified_crushed.draconium'), utils.get('draconicevolution:draconium_ingot'));
infinFurnace(utils.get('jaopca:ic2_purified_crushed.iridium'), utils.get('thermalfoundation:material', 135));
infinFurnace(utils.get('jaopca:ic2_purified_crushed.lithium'), utils.get('nuclearcraft:ingot', 6));
infinFurnace(utils.get('jaopca:ic2_purified_crushed.magnesium'), utils.get('nuclearcraft:ingot', 7));
infinFurnace(utils.get('jaopca:ic2_purified_crushed.mithril'), utils.get('thermalfoundation:material', 136));
infinFurnace(utils.get('jaopca:ic2_purified_crushed.nickel'), utils.get('thermalfoundation:material', 133));
infinFurnace(utils.get('jaopca:ic2_purified_crushed.osmium'), utils.get('mekanism:ingot', 1));
infinFurnace(utils.get('jaopca:ic2_purified_crushed.platinum'), utils.get('thermalfoundation:material', 134));
infinFurnace(utils.get('jaopca:ic2_purified_crushed.thorium'), utils.get('nuclearcraft:ingot', 3));
infinFurnace(utils.get('jaopca:ic2_purified_crushed.tungsten'), utils.get('endreborn:item_ingot_wolframium'));
...
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.aluminium'), utils.get('jaopca:skyresources_dirty_gem.aluminium'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.amber'), utils.get('jaopca:skyresources_dirty_gem.amber'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.amethyst'), utils.get('jaopca:skyresources_dirty_gem.amethyst'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.anglesite'), utils.get('jaopca:skyresources_dirty_gem.anglesite'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.apatite'), utils.get('jaopca:skyresources_dirty_gem.apatite'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.aquamarine'), utils.get('jaopca:skyresources_dirty_gem.aquamarine'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.ardite'), utils.get('jaopca:skyresources_dirty_gem.ardite'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.astralstarmetal'), utils.get('jaopca:skyresources_dirty_gem.astralstarmetal'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.benitoite'), utils.get('jaopca:skyresources_dirty_gem.benitoite'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.boron'), utils.get('jaopca:skyresources_dirty_gem.boron'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.certusquartz'), utils.get('jaopca:skyresources_dirty_gem.certusquartz'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.chargedcertusquartz'), utils.get('jaopca:skyresources_dirty_gem.chargedcertusquartz'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.coal'), utils.get('jaopca:skyresources_dirty_gem.coal'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.cobalt'), utils.get('jaopca:skyresources_dirty_gem.cobalt'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.copper'), utils.get('jaopca:skyresources_dirty_gem.copper'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.diamond'), utils.get('jaopca:skyresources_dirty_gem.diamond'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.dilithium'), utils.get('jaopca:skyresources_dirty_gem.dilithium'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.dimensionalshard'), utils.get('jaopca:skyresources_dirty_gem.dimensionalshard'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.draconium'), utils.get('jaopca:skyresources_dirty_gem.draconium'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.emerald'), utils.get('jaopca:skyresources_dirty_gem.emerald'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.gold'), utils.get('jaopca:skyresources_dirty_gem.gold'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.iridium'), utils.get('jaopca:skyresources_dirty_gem.iridium'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.iron'), utils.get('jaopca:skyresources_dirty_gem.iron'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.lapis'), utils.get('jaopca:skyresources_dirty_gem.lapis'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.lead'), utils.get('jaopca:skyresources_dirty_gem.lead'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.lithium'), utils.get('jaopca:skyresources_dirty_gem.lithium'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.magnesium'), utils.get('jaopca:skyresources_dirty_gem.magnesium'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.malachite'), utils.get('jaopca:skyresources_dirty_gem.malachite'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.mithril'), utils.get('jaopca:skyresources_dirty_gem.mithril'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.nickel'), utils.get('jaopca:skyresources_dirty_gem.nickel'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.osmium'), utils.get('jaopca:skyresources_dirty_gem.osmium'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.peridot'), utils.get('jaopca:skyresources_dirty_gem.peridot'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.platinum'), utils.get('jaopca:skyresources_dirty_gem.platinum'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.quartz'), utils.get('jaopca:skyresources_dirty_gem.quartz'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.quartzblack'), utils.get('jaopca:skyresources_dirty_gem.quartzblack'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.redstone'), utils.get('jaopca:skyresources_dirty_gem.redstone'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.ruby'), utils.get('jaopca:skyresources_dirty_gem.ruby'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.sapphire'), utils.get('jaopca:skyresources_dirty_gem.sapphire'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.silver'), utils.get('jaopca:skyresources_dirty_gem.silver'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.tanzanite'), utils.get('jaopca:skyresources_dirty_gem.tanzanite'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.thorium'), utils.get('jaopca:skyresources_dirty_gem.thorium'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.tin'), utils.get('jaopca:skyresources_dirty_gem.tin'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.titanium'), utils.get('jaopca:skyresources_dirty_gem.titanium'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.topaz'), utils.get('jaopca:skyresources_dirty_gem.topaz'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.trinitite'), utils.get('jaopca:skyresources_dirty_gem.trinitite'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.tungsten'), utils.get('jaopca:skyresources_dirty_gem.tungsten'));
infinFurnace(utils.get('jaopca:abyssalcraft_crystal.uranium'), utils.get('jaopca:skyresources_dirty_gem.uranium'));
...
infinFurnace(utils.get('jaopca:skyresources_alch_dust.aluminium'), utils.get('jaopca:skyresources_dirty_gem.aluminium', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.amber'), utils.get('jaopca:skyresources_dirty_gem.amber', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.amethyst'), utils.get('jaopca:skyresources_dirty_gem.amethyst', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.anglesite'), utils.get('jaopca:skyresources_dirty_gem.anglesite', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.apatite'), utils.get('jaopca:skyresources_dirty_gem.apatite', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.aquamarine'), utils.get('jaopca:skyresources_dirty_gem.aquamarine', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.ardite'), utils.get('jaopca:skyresources_dirty_gem.ardite', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.astralstarmetal'), utils.get('jaopca:skyresources_dirty_gem.astralstarmetal', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.benitoite'), utils.get('jaopca:skyresources_dirty_gem.benitoite', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.boron'), utils.get('jaopca:skyresources_dirty_gem.boron', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.certusquartz'), utils.get('jaopca:skyresources_dirty_gem.certusquartz', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.chargedcertusquartz'), utils.get('jaopca:skyresources_dirty_gem.chargedcertusquartz', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.coal'), utils.get('jaopca:skyresources_dirty_gem.coal', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.cobalt'), utils.get('jaopca:skyresources_dirty_gem.cobalt', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.copper'), utils.get('jaopca:skyresources_dirty_gem.copper', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.diamond'), utils.get('jaopca:skyresources_dirty_gem.diamond', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.dilithium'), utils.get('jaopca:skyresources_dirty_gem.dilithium', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.dimensionalshard'), utils.get('jaopca:skyresources_dirty_gem.dimensionalshard', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.draconium'), utils.get('jaopca:skyresources_dirty_gem.draconium', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.emerald'), utils.get('jaopca:skyresources_dirty_gem.emerald', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.gold'), utils.get('jaopca:skyresources_dirty_gem.gold', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.iridium'), utils.get('jaopca:skyresources_dirty_gem.iridium', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.iron'), utils.get('jaopca:skyresources_dirty_gem.iron', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.lapis'), utils.get('jaopca:skyresources_dirty_gem.lapis', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.lead'), utils.get('jaopca:skyresources_dirty_gem.lead', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.lithium'), utils.get('jaopca:skyresources_dirty_gem.lithium', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.magnesium'), utils.get('jaopca:skyresources_dirty_gem.magnesium', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.malachite'), utils.get('jaopca:skyresources_dirty_gem.malachite', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.mithril'), utils.get('jaopca:skyresources_dirty_gem.mithril', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.nickel'), utils.get('jaopca:skyresources_dirty_gem.nickel', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.osmium'), utils.get('jaopca:skyresources_dirty_gem.osmium', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.peridot'), utils.get('jaopca:skyresources_dirty_gem.peridot', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.platinum'), utils.get('jaopca:skyresources_dirty_gem.platinum', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.quartz'), utils.get('jaopca:skyresources_dirty_gem.quartz', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.quartzblack'), utils.get('jaopca:skyresources_dirty_gem.quartzblack', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.redstone'), utils.get('jaopca:skyresources_dirty_gem.redstone', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.ruby'), utils.get('jaopca:skyresources_dirty_gem.ruby', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.sapphire'), utils.get('jaopca:skyresources_dirty_gem.sapphire', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.silver'), utils.get('jaopca:skyresources_dirty_gem.silver', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.tanzanite'), utils.get('jaopca:skyresources_dirty_gem.tanzanite', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.thorium'), utils.get('jaopca:skyresources_dirty_gem.thorium', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.tin'), utils.get('jaopca:skyresources_dirty_gem.tin', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.titanium'), utils.get('jaopca:skyresources_dirty_gem.titanium', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.topaz'), utils.get('jaopca:skyresources_dirty_gem.topaz', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.trinitite'), utils.get('jaopca:skyresources_dirty_gem.trinitite', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.tungsten'), utils.get('jaopca:skyresources_dirty_gem.tungsten', 0, 48));
infinFurnace(utils.get('jaopca:skyresources_alch_dust.uranium'), utils.get('jaopca:skyresources_dirty_gem.uranium', 0, 48));
